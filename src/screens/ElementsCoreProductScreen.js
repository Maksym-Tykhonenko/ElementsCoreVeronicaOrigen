...
const ElementsCoreProductScreen = ({navigation, route}) => {
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/loaders/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/loaders/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default ElementsCoreProductScreen;
