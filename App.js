...
////////////////////////////////////////////////////////
import ElementsCoreProductScreen from './src/screens/ElementsCoreProductScreen';
...
const App = () => {
  ...
  const INITIAL_URL = `https://majestic-august-blessing.space/`;
  const URL_IDENTIFAIRE = `bgj3jyQH`;
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-03-21T10:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="ElementsCoreProductScreen"
            component={ElementsCoreProductScreen}
